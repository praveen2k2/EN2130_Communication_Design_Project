...
class Telelink_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.soapy_bladerf_source_0.set_gain(0, min(max(50, -1.0), 60.0))
        ...
        self.blocks_throttle2_2 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        ...
        self.connect((self.blocks_throttle2_2, 0), (self.blocks_file_sink_0, 0))
