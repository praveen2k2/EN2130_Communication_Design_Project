...
class Telelink_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, MTU=1500):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Telelink_transmitter")
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, './tx.tmp', False)
